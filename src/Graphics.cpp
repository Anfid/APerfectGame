...
Graphics::Graphics() {
    SDL_CreateWindowAndRenderer(globals::windowWidth, globals::windowHeight, SDL_WINDOW_RESIZABLE, &this->window, &this->renderer);
...
SDL_Texture* Graphics::createTexture(const std::string &filepath) {
